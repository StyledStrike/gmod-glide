...
if SERVER then
    ...
    -- Trailer convars
    CreateConVar( "glide_trailer_attach_percentage_wheel", "0.6", FCVAR_ARCHIVE + FCVAR_NOTIFY + FCVAR_REPLICATED, "Percentage of wheels required on trailer to attach it to a vehicle.", 0, 1 )
end
...
CreateConVar( "glide_allow_player_weapons_in_vehicle", "0", FCVAR_ARCHIVE + FCVAR_REPLICATED, "Allows player to use their own weapons in a vehicle.", 0, 1 )
